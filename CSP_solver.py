#ARC CONSISTENCY AND DOMAIN CONSISTENCY SCRIPT
...
class Arc_Consistency(Displayable):
    ...
    def make_arc_consistent(self, orig_domains=None, to_do=None):
        ...
        self.display(2, 'pruning effettuati: ',count)
...
class Search_with_AC_from_CSP(Search_problem,Displayable):
    ...
    def __init__(self, csp):
        self.cons = Arc_Consistency(csp)  #copy of the CSP
...
def ac_solver(csp):
    ...
    return Arc_Consistency(csp).solve_one()